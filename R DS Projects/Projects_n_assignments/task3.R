...
#how much RAM is being used by each of my objects inside my current workspace
sort( sapply(ls(),function(x){object.size(get(x))}))

#GC automatically releases memory when an object is no longer used. It does this by tracking how
#many names point to each object, and when there are no names pointing to an object, it deletes that object.
